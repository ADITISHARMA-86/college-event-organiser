...
export default function RootLayout({
  ...
  <div className="relative z-10 min-h-[70vh]"></div>
   {/* Footer */}
        <footer className="border-t border-gray-800/50 py-8 px-6 max-w-7xl mx-auto"> {/*py= vertical padding px= horizonal padding*/}         
        <div className="text-sm text-gray-400">Made with ❤️ by AditiCoder</div>
        </footer>
</main>
</ThemeProvider>
